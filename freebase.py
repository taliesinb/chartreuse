...
class movie:
	...
	def actors_in_common(self, movie):
		query = [{"type":"/film/actor","id":null,"/film/actor/film":{"/film/performance/film":{"id":self.id}},"/film/actor/film":{"/film/performance/film":{"id":movie.id}}}]
		return [entry.get("id",None) for entry in mql(query)]
	def characters_in_common(self,movie):
		query = [{"type":"/film/film_character","id":null,"/film/film_character/portrayed_in_films":{"/film/performance/film":{"id":self.id}},"/film/film_character/portrayed_in_films":{"/film/performance/film":{"id":movie.id}}}]
		return [entry.get("id",None) for entry in mql(query)]
...
class actor:
	def __init__(self, id):
		self.id = id
	def movies(self):
		query = {"id":self.id, "/film/actor/film" : [{"/film/performance/film":{"id":null}, "/film/performance/character":{"id":null}}]}
	...
	def movies_in_common(self, actor):
		query = [{"type":"/film/film","id":None,"/film/film/starring":[{"actor":{"id":self.id}}],"/film/film/starring":[{"actor":{"id":actor.id}}]}]
		return [entry.get("id",None) for entry in mql(query)]
